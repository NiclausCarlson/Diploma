...
REFERENCE_PATH = RESOURCES_PATH + "references/"
VIDEO_PATH = RESOURCES_PATH + "videos/"


def ar_main(video_path, marked_reference, model_path, args):
    """
...
def render(img, obj, projection, model, color=False):
    """
    Render a loaded obj model into the current videos frame
    """
    ...
    for face in obj.faces:
        ...
        # render model in the middle of the references surface. To do so,
...
# parser.add_argument('-ref', '--reference', help='references title')
